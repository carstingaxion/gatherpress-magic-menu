...
(0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_1__.addFilter)('blocks.registerBlockType', 'gatherpress-magic-menu/allow-in-core-navigation', (settings, name) => {
  ...
  return {
    ...settings,
    allowedBlocks: [...(settings.allowedBlocks ?? []), 'gatherpress-magic-menu']
  };
});
...
/******/ 		}
/******/ 		
/******/ 		const chunkLoadingGlobal = globalThis["webpackChunkblock_gatherpress_magic_menu"] ||= [];
